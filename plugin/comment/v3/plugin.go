...
// Package v3 provides V3-compatible comment handling.
//
// This plugin replicates the comment attachment behavior from go-yaml v3,
// providing backward compatibility for code that relies on comment
// processing.
//
// # Usage
//
...
// ProcessMappingPair handles foot comment migration for mapping key-value
// pairs.
