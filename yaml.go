...
//
// You can also use the [WithKnownFields] option when using [NewDecoderWithOptions].
...
//
// You can also use the [WithIndent] option when using [NewEncoderWithOptions].
...
//
// You can also use the [WithCompactSequenceIndent] option when using [NewEncoderWithOptions].
